...
final List<String> addressFields = [
	'First name', 'Last name', 'Company', 'Flat/Building Name', 'Area/Street', 'City', 'Country', 'State', 'Postal/Zip code', 'Phone'
];
...
class _CustomerAddressEditState extends State<CustomerAddressEdit> {
			...
			MutationOptions(
				...
				variables: {
					...
					'address': {
						...
						'State': _addressSavedFields['State'],
	...
	String? getInitialValueEditAddress(String field) {
		switch (field) {
			...
			case 'State': return widget.address['State'];
