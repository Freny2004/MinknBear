...
class _ContactState extends State<Contact> {
  ...
  void initState() {
    ...
    _controller.loadRequest(Uri.parse('https://minknbear.com/pages/contact'));  // Load the checkout URL
  }
  ...
  void _addAuthenticationToken() {
    ...
    _controller.loadRequest(Uri.parse('https://minknbear.com/pages/contact').replace(queryParameters: {'token': 'userAuthToken'})); // Add token if needed
  }
