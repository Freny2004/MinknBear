								...
								children: [
									...
									ElevatedButton(
										onPressed: () async {
											...
											if (context.mounted) {
												Navigator.of(context).push(MaterialPageRoute(builder: (context) => CartCheckout(checkoutUrl: context.read<CartModel>().cart!['checkoutUrl'],)));
											}
										},
										style: ButtonStyle(
											...
											overlayColor: WidgetStateProperty.all(Colors.white.withOpacity(.25)),
										),
										child: const Row(
