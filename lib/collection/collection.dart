...
class _CollectionPageState extends State<CollectionPage> {
	...
	Widget build(BuildContext context) {
		return Scaffold(
			...
			body: _products == null
				? const Center(child: CircularProgressIndicator(semanticsLabel: 'Loading, please wait',color: Colors.black,))
				: _products!.isEmpty
					? Center(
						child: Column(
							mainAxisAlignment: MainAxisAlignment.center,
							...
							children: [
								Expanded(
									child: GridView.count(
										...
										crossAxisCount: MediaQuery.of(context).size.width > 600 ? 3 : 2,  // Number of columns
										childAspectRatio:  MediaQuery.of(context).size.width > 600 ? 0.75 : 0.5,  // Aspect ratio for cards
										padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 5),  // Consistent padding
